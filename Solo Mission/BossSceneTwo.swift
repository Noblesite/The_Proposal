...
//  Solo Mission
//
//  Created by Jonathon Poe on 4/18/18.
...
class BossSceneTwo: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        for i in 0...1{
            ...
            let background = SKSpriteNode(imageNamed: "backgroundBoss2")
        ...
        tapToStartLabel.text = "Final Level!"
    ...
    func startNewLevel(){
        ...
        let spwan = SKAction.run(startAndSetEnemyTwoSpawn)
    ...
    func spawnEnemyTwo(){
        ...
        let enemy = SKSpriteNode(imageNamed: "level3Enime2")
        enemy.name = "Enemy"
        enemy.setScale(0.15)
    ...
    func spawnBoss(){
        ...
        let boss = SKSpriteNode(imageNamed: "SubBossShip")
        boss.name = "Boss1"
        boss.setScale(2)
    ...
    func randomBossPostion(){
        ...
        self.enumerateChildNodes(withName: "Boss1"){
            ...
            let bossMove = SKAction.moveTo(x: randomX, duration: 0.3)
    ...
    func spawnBossTwo(){
        ...
        bossHealthPoints = 400
        bossLevel = 0
        
        let startPoint = CGPoint(x: self.size.width/2 , y: self.size.height * 1.2)
        let endPoint = CGPoint(x: self.size.width/2 , y: self.size.height*0.9)
        
        let boss = SKSpriteNode(imageNamed: "BossShip2")
        boss.name = "Boss1"
        boss.setScale(0.75)
        boss.position = startPoint
        boss.zPosition = 3
    ...
    func runGameWin(){
        ...
        let bonusScoreFromLifes = livesNumber * 100
        
        gameScore = gameScore + bonusScoreFromLifes
